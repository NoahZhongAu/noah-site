  ...
  eras: [
    {
      ...
      alt: "A row of wooden desks in a night meadow, clerks seen from behind working mechanical adding machines under one green desk lamp.",
      fromStep: 1,
      toStep: 2,
    },
    {
      ...
      alt: "A wall-sized relay machine standing in a night meadow, paper tape threading through readers, one figure facing it from behind.",
      fromStep: 3,
      toStep: 3,
    },
    {
      ...
      alt: "A row of 1960s mainframe cabinets in a night meadow, two technicians in white coats at a console seen from behind.",
      fromStep: 4,
      toStep: 4,
    },
    {
      ...
      alt: "A small wooden desk in a night meadow with a glowing beige CRT monitor, floppy disks and a coiled modem cord in the flowers.",
      fromStep: 5,
      toStep: 5,
    },
    {
      ...
      alt: "A young man in a white shirt seen from behind at a small wooden desk in a night meadow, laptop glowing warm yellow.",
      fromStep: 6,
      toStep: 6,
    },
  ],
